...
def add_data_options(parser):
    ...
    group.add_argument("--dataset", default='celebv', choices=["celebv", "celebv_short"], type=str,
...
def add_generate_options(parser):
    ...
    group.add_argument("--motion_length", default=3.0, type=float,
...
def add_evaluation_options(parser):
    ...
    group.add_argument("--guidance_param", default=2.5, type=float,
                       help="For classifier-free sampling - specifies the s parameter, as defined in the paper.")
    group.add_argument("--compression_model_path", default = "./eval_model/Compression_v1/model000003160.pt", type = str, help = "Path to the compression model to be used")
    group.add_argument("--filter_region_pickle", default = "./eval_model/vertex_id_to_face_region.pkl", type = str, help = "Path to the Pickle file containing a naming for the vertices")


def get_cond_mode(args):
    if args.unconstrained:
        cond_mode = 'no_cond'
    elif args.dataset in ['kit', 'humanml', "celebv"]:
        cond_mode = 'text'
    else:
        cond_mode = 'action'
    return cond_mode
