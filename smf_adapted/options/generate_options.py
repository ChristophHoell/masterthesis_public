...
class GenerateOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument("--motion_length", default=3.0, type=float, help="The length of the generated motion [in seconds] when using prompts. Maximum is 9.8 for HumanML3D (text-to-motion)")
