...
if __name__ == '__main__':
    ...
    dataloader = load_dataset(opt, mode = "gt")
    all_motions = []
    all_text = []
    ...
    samples = pipeline.generate(texts, torch.LongTensor([int(x) for x in motion_lens]))[0]
    ...
    print(f"Saving results.frame to {out_path}")
